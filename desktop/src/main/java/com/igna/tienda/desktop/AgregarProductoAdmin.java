...
public class AgregarProductoAdmin extends JFrame {
    ...
    public AgregarProductoAdmin(Frame owner, AdminServiceTx adminTx) {
    ...
    private JPanel buildContent() {
        ...
        JLabel title = ModernTheme.createTitleLabel("Nuevo Producto");
    ...
    private void wireEvents() {
        ...
        fechaVencimientoField.addActionListener(e -> guardarProducto());
    }
    ...
    private void guardarProducto() {
        try {
            ...
            setBusy(true);
            adminTx.agregarProducto(producto);
    ...
    private Producto construirProductoDesdeFormulario() {
        ...
        boolean stock = cantidad > 0;
        return new Producto(nombre, descripcion, categoria, precio, cantidad, cantidadMinima, fechaVencimiento, stock);
    }
